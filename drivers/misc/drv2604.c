...
static int dev_auto_calibrate(struct drv2604_data *pDrv2604data)
{
	...
	pr_debug("%s, calibration status =0x%x\n", __FUNCTION__, status);
...
static int drv2604_probe(struct i2c_client *client, const struct i2c_device_id *id)
{
	...
	case DRV2605_VER_1DOT1:
		pr_debug("drv2604 driver found: drv2605 v1.1.\n");
		break;
	case DRV2605_VER_1DOT0:
		pr_debug("drv2604 driver found: drv2605 v1.0.\n");
		break;
	case DRV2604:
		pr_debug("drv2604 driver found: drv2604.\n");
		break;
	case DRV2604L:
		pr_debug("drv2604 driver found: drv2604L.\n");
		break;
	case DRV2605L:
		pr_debug("drv2604 driver found: drv2605L.\n");
		break;
	default:
		pr_debug("drv2604 driver found: unknown.\n");
		break;
	}
	...
	pr_debug("drv2604 probe succeeded\n");
