...
static int dynamic_stune_boost_top_app = 10;
module_param(dynamic_stune_boost_top_app, uint, 0644);
static int dynamic_stune_boost_rt = 10;
module_param(dynamic_stune_boost_rt, uint, 0644);
...
static void do_input_boost(struct work_struct *work)
{
	...
	do_stune_boost("top-app", dynamic_stune_boost_top_app);
	do_stune_boost("rt", dynamic_stune_boost_rt);
#endif /* CONFIG_DYNAMIC_STUNE_BOOST */
